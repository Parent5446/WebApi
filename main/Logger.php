 ...
 *
 * The format for the log entries is "$time ($pid - $id) : $level [$callback] - $message",
 * where $time is the time, $pid is the process ID, $id is a unique ID created
 * at the beginning of the script, $level is the error type, $callback is the function
 * that triggered the error, and $message is the actual error.
 *
 * @package API
